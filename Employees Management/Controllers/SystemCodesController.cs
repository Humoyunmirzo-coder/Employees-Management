...
namespace Employees_Management.Controllers
{
    public class SystemCodesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,CreateId,CreateOn,ModifiedById,ModifiedOn")] SystemCode systemCode)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,CreateId,CreateOn,ModifiedById,ModifiedOn")] SystemCode systemCode)
        {
            if (id != systemCode.Id)
            {
                return NotFound();
