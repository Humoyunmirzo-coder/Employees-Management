...
namespace Employees_Management.Controllers
{
    public class DesignationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Name,CreateId,CreateOn,ModifiedById,ModifiedOn")] Designation designation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Name,CreateId,CreateOn,ModifiedById,ModifiedOn")] Designation designation)
        {
